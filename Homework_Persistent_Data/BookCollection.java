 ...
 * <p>
 * You are free to create helper methods within this class to help achieve each task.
 */
public class BookCollection implements Serializable {
    ...
    public void saveToBespokeFile(File file) {
        // TODO: Implement this method yourself. The specific hierarchy is up to you,
    ...
    /**
     * Saves this collection to the specified "serializabl" file.
     *
     * @param file The path to a file.
     */
    public void saveToSerializableFile(File file) {
        // TODO: Implement this method yourself. The specific hierarchy is up toy ou,
        // But it must be in Java Serialization format and should match the load method.
    ...
    public void saveToJSONFile(File file) {
        // TODO: Implement this method yourself. The specific hierarchy is up to you,
        // but it must be in a JSON format and should match the load method.
    ...
    public void saveToXMLFile(File file) {
        // TODO: Implement this method yourself. The specific hierarchy is up to you,
        // but it must be in an XML format and should match the load method.
    ...
    public static BookCollection loadFromBespokeFile(File file) {
        ...
        return null; // Change this return (this is here as a placeholder to prevent an error).
    }
     ...
     * @return An initialised book collection.
     */
    public static BookCollection loadFromSerializableFile(File file) {
        // TODO: Implement this method yourself.
